...
from src.service.rendicion_service import RendicionService
from src.controller.rendicion_controller import create_rendicion_blueprint
...
async def setup_db():
    ...
    if _engine is None or _loop != current_loop:
        ...
        from src.models.rendicion_db import Base
...
async def inject_dependencies():
    ...
    repo = RendicionRepository(session)
    g.current_service = RendicionService(repo)
...
# Registrar blueprint
bp = create_rendicion_blueprint()

app.register_blueprint(bp, url_prefix='/api/v1/rendiciones')
