...
async def setup_db():
    ...
    if _engine is None or _loop != current_loop:
        ...
        from src.models.solicitud_db import Base
...
async def inject_dependencies():
    ...
    repo = SolicitudRepository(session)
    service = SolicitudService(repo)
...
# Registrar blueprint
bp = create_solicitud_blueprint()

app.register_blueprint(bp, url_prefix='/api/v1/solicitudes')
